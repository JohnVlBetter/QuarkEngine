...
namespace Quark {
	...
	public:
		...
		static void DrawQuad(const glm::mat4& transform, const SPtr<Texture2D>& texture, float tilingFactor = 1.0f, const glm::vec4& tintColor = glm::vec4(1.0f), int entityID = -1);
